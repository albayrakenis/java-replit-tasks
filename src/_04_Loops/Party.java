...
public class Party {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 
		 * Please enter guest name: Nick
		 * 
		 * Do you want to enter new guest name: yes
		 * 
		 * Please enter guest name: Linda
		 * 
		 * Do you want to enter new guest name: no
		 * 
